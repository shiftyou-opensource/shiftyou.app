...
Future<void> setUpInjector() async {
  ...
  var custom = SchedulerRules(AppLocalization.getWithKey(Keys.Scheduler_Name_Weekly_Cadence), false);
  schedulerRules.add(custom);
  var manual = SchedulerRules(AppLocalization.getWithKey(Keys.Scheduler_Name_Up_To_You), false);
  manual.manual = true;
